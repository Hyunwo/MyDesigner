...
const StudentcutScreen = () => {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <Text style={styles.serviceTitle}>학생 커트(0세-19세)</Text>
      ...
      <View style={styles.details}>
        ...
        <View style={styles.detailRow}>
          ...
          <Text style={styles.detailText}>30분 소요</Text>
        </View>
        <View style={styles.detailRow}>
      ...
      {/* Booking Button */}
      <TouchableOpacity style={styles.bookingButton} onPress={() => navigation.navigate('StudentcutReservation')}>
...
export default StudentcutScreen;